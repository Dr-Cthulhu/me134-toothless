...
int main(int argc, char **argv)
{
  ...
  ros::Publisher cmdPub =
    nh.advertise<sensor_msgs::JointState>("/ikin_joint_states", 100);

  sensor_msgs::JointState cmdMsg;
  cmdMsg.name.push_back("134/motor1");
  cmdMsg.name.push_back("134/motor2");
  cmdMsg.name.push_back("134/motor3");
  cmdMsg.name.push_back("134/motor4");
  cmdMsg.name.push_back("134/motor5");
