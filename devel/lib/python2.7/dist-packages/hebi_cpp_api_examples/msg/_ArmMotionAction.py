...
class ArmMotionAction(genpy.Message):
  _md5sum = "0d844071d0f48836d9d09675d01fa085"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.x))
      length = len(self.action_goal.goal.y)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.y))
      length = len(self.action_goal.goal.z)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.z))
      length = len(self.action_goal.goal.tipx)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.tipx))
      length = len(self.action_goal.goal.tipy)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.tipy))
      length = len(self.action_goal.goal.tipz)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.tipz))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.x = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.y = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.z = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.tipx = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.tipy = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.tipz = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 16
